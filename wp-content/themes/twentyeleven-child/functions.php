...
{
    wp_enqueue_style( 'shadowbox', get_template_directory_uri().'/js/shadowbox/shadowbox.css', false, false, 'all' );
    wp_enqueue_style( 'jcarousel', get_template_directory_uri().'/jcarousel.css', false, false, 'all' );
    wp_enqueue_style( 'jcarousel_ie7', get_template_directory_uri().'/skins/ie7/skin.css', false, false, 'all' );
    wp_enqueue_style( 'jcarousel_tango', get_template_directory_uri().'/skins/tango/skin.css', false, false, 'all' );
    wp_enqueue_script( 'shadowbox', get_template_directory_uri().'/js/shadowbox/shadowbox.js', array( 'jquery' ), false, true );
    wp_enqueue_script( 'fn', get_template_directory_uri().'/js/fn.js', array( 'jquery' ), false, true );
    wp_enqueue_script( 'jquery.embedly.min', get_template_directory_uri().'/js/jquery.embedly.min.js', array( 'jquery' ), false, true );
    wp_enqueue_script( 'jquery.jcarousel.min', get_template_directory_uri().'/js/jquery.jcarousel.min.js', array( 'jquery' ), false, true );
}
add_action( 'template_redirect',  'init_template' );
*/



////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////// MMM OOO DDD III FFF III CCC AAA TTT III OOO NNN SSS ///////////////////////
//////////////////// MMM OOO DDD III FFF III CCC AAA TTT III OOO NNN SSS ///////////////////////
//////////////////// MMM OOO DDD III FFF III CCC AAA TTT III OOO NNN SSS ///////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////
...
function my_show_columns($name, $ID) {
    var_dump($name);
    global $post;
    var_dump($post);
    switch ($name) {
        case 'unit':
            $views = get_post_meta($post->ID, 'module-parent', true);
            echo $views;
    }
}
*/
