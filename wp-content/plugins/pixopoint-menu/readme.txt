...
Description: Adds a new menu to your WordPress powerwed site and allows you to control it's content via an easy user to interface. Visit the <a href="http://pixopoint.com/pixopoint-menu/">PixoPoint Menu Plugin page</a> for more information about the plugin. For help with styling your menu please visit the <a href="http://pixopoint.com/suckerfish_css/">PixoPoint menu CSS generator</a> to obtain custom CSS. Paid premium support for this plugin is available via the <a href="http://pixopoint.com/premium-support/">PixoPoint Premium Support service</a>. We no longer provide free support for menus sorry.

== Description ==

Adds an SEO friendly, accessible regular or dropdown menu to your WordPress blog. Visit the <a href="http://pixopoint.com/pixopoint-menu/">PixoPoint Menu Plugin page</a> for more information about the plugin.
...
We no longer provide free support for menu issues sorry.
