...
function wec_setSystemTimeZone() {	
	?>
	<a name="setTimeZone"></a>
	<h3>Time Zone Settings</h3>
Select which time zone you would like events to be displayed in by default
<?php
...
$current_offset = get_option('gmt_offset');
$tzstring = calendarPlugin::getDefaultTimeZoneName();
...
<?php echo wp_timezone_choice($tzstring); ?>
    ...
    <span id="utc-time"><?php printf(__('<abbr title="Coordinated Universal Time">UTC</abbr> time is <code>%s</code>'), $timeManager->convertToTimeZone(date('U'),"UTC", 'Y-m-d G:i:s')); ?></span>
<?php if ( get_option('timezone_string') ) : ?>
	<span id="local-time"><?php printf(__('Local time is <code>%1$s</code>'), $timeManager->convertToTimeZone(date('U'),$tzstring, 'Y-m-d G:i:s')); ?></span>
<?php endif; ?><br />
